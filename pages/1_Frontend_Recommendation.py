...
@st.cache_data
def load_data():
    books_df = pd.read_csv(r'C:\Users\Akshaya\OneDrive\Desktop\Internship\project\Good Books\books.csv')
    tags_df = pd.read_csv(r'C:\Users\Akshaya\OneDrive\Desktop\Internship\project\Good Books\tags.csv')
    book_tags = pd.read_csv(r'C:\Users\Akshaya\OneDrive\Desktop\Internship\project\Good Books\book_tags.csv')
